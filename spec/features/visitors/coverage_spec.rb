  ...
  describe 'GET /coverage' do
    ...
    context 'Coverage list' do
      ...
      it 'shoud have setup_price and monthly_price for included channels for group from Ukraine' do
        ...
        puts "\nSKU ID: #{ua_sku.id}"
        puts "SKU setup_price: #{ua_sku.setup_price}"
        puts "SKU monthly_price: #{ua_sku.monthly_price}"
        puts "SKU channels_included_count: #{ua_sku.channels_included_count}"
      ...
      it 'shoud have setup_price and monthly_price for included channels for group from United States' do
        ...
        puts "\nSKU ID: #{ua_sku.id}"
        puts "SKU setup_price: #{us_sku.setup_price}"
        puts "SKU monthly_price: #{us_sku.monthly_price}"
        puts "SKU channels_included_count: #{us_sku.channels_included_count}"
